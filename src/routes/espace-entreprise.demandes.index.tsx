...
function DemandesPage() {
  ...
  const all = MOCK_DEMANDES.filter((d) => d.partenaire === "Orange Sénégal");
  ...
  return (
    <PartnerShell>
      <PageHeader
        ...
        description="Suivez l'avancement de chaque demande et les candidats proposés."
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-soft">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {list.length === 0 && (
              <tr><td colSpan={7} className="px-4 py-12 text-center text-sm text-ink-soft">Aucune demande trouvée.</td></tr>
            )}
          </tbody>
        </table>
      </div>
